...
package() {
	...
	install -Dm644 anime/* -t "$pkgdir/usr/share/backgrounds/viper/anime/"
	install -Dm644 catppuccin/* -t "$pkgdir/usr/share/backgrounds/viper/catppuccin/"
	install -Dm644 dragons/* -t "$pkgdir/usr/share/backgrounds/viper/dragons/"
	install -Dm644 evangelion/* -t "$pkgdir/usr/share/backgrounds/viper/evangelion/"
	install -Dm644 exodia/* -t "$pkgdir/usr/share/backgrounds/viper/exodia/"
	install -Dm644 gruvbox/* -t "$pkgdir/usr/share/backgrounds/viper/gruvbox/"
	...
	install -Dm644 misc/* -t "$pkgdir/usr/share/backgrounds/viper/misc/"
